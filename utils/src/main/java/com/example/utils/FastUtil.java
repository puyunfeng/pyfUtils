...
public class FastUtil {
    ...
    public static View getRootView(Activity activity) {
        ...
        if (ref.get().getWindow().getDecorView().findViewById(android.R.id.content) == null) {
            return null;
        }
        return ((ViewGroup) ref.get().getWindow().getDecorView().findViewById(android.R.id.content)).getChildAt(0);
    }
    /**
     * 获取DecorView根布局
     *
     ...
     * @return
     */
    public static View getDecorViewView(Activity activity) {
        WeakReference<Activity> ref = new WeakReference<>(activity);
        if (ref.get() == null) {
            return null;
        }
        ...
        return ((ViewGroup) ref.get().getWindow().getDecorView().findViewById(android.R.id.content));
    }
